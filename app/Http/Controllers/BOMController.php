...
class BOMController extends Controller
{
    ...
    public function index() {
        ...
        return view('modules.manufacturing.bom', ['man_boms' => $man_boms]);
    }
    ...
    public function search_product(Request $request) {
        try {
            ...
            $data = ManufacturingProducts::select('product_name', 'unit', 'materials')->where('product_code', $product_code)->first();
            $product_name = $data->product_name;
            $product_unit = $data->unit;
            $product_mat = $data->materials();
            //echo "<script>alert('" . count($product_mat) . "');</script>";
    ...
    public function checkIfBOMExists($bom_id) {
        try {
            $result = (BillOfMaterials::find($bom_id));
            return $result !== null;
        } catch (Exception $e){
