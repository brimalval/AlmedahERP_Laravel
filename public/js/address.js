...
function addRow(){
    ...
    let lastRow = $('#address-input-rows tr:last');
    let nextID = (lastRow.length != 0) ? lastRow.data('id') + 1 : 0;
    $('#address-input-rows').append(
    `<tr data-id="${nextID}">
        ...
        <td id="mr-code-input" class="mr-code-input"><input type="text" value="" readonly name="doc_type" id="doc_type" class="form-control"></td>
        <td style="width: 10%;" class="mr-qty-input"><input type="text" value="" readonly name="name" id="name" class="form-control"></td>
        <td class="mr-unit-input"><input type="text" value="" readonly name="title" id="title" class="form-control"></td>
