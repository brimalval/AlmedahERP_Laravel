$(".delete-js-form")
    ...
    .on("submit", function (e) {
        e.preventDefault();
        // ID of the jobsched being deleted
        let jsid = $(this).data("js");
        let form = this;
        swal({
            title: `Are you sure you would like to delete ${jsid}?`,
            icon: "warning",
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        swal({
                            title: `Successfully deleted ${jsid}.`,
                            icon: "success",
                        });
                    },
                    error: function (data) {
