        ...
        <div class="card-body filter">
            <div class="row">
              <div class="col">
                ...
                <input type="text" class="form-control" placeholder="Tracking ID" value="" readonly>
              </div>
              <div class="col">
                <label for="">Move Date</label>
                <input type="text" class="form-control" placeholder="Move Date" value="" readonly>
              </div>
              </div>
              <div class="row">
                  <div class="col-6">
                    <label for="">Stock Moves Type</label>
                    <input type="text" class="form-control" placeholder="" value="Return" readonly>
                  </div>
                  <div class="col-6">
                    <label for="">Return Date</label>
                    <input type="text" class="form-control" placeholder="Return Date" value="">
                  </div>
              </div>
              <div class="row">
                  <div class="col-6">
                    <label for="">Materials Ordered ID</label>
                    <input type="text" class="form-control" placeholder="Materials Ordered ID" value="" readonly>
                  </div>
                </div>
                <div class="row">
                    <div class="col-6">
                      <label for="">Employee ID</label>
                      <input type="text" class="form-control" placeholder="Employee ID" value="" readonly>
                    </div>
                  </div>
            </div>
        <hr>
