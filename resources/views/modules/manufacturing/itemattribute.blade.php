<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <h2 class="navbar-brand" style="font-size: 35px;">Item Attribute</h2>
                    ...
                    <table class="table table-hover h-100">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" style="width: 20%;">Attribute Name</th>
                                <th scope="col" style="width: 50%;" colspan="5">&nbsp;</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php for ($i = 1; $i <= 10; $i++) : ?>
                            ...
                            <!-- <tr>
                                <td colspan="8">
                                    <div class="text-center" style="padding-top: 100px; padding-bottom: 100px;">
                                        <h4>No Item Attribute Found</h4><br>
                                        <button class="btn btn-primary" onclick="openManufacturingItemAttributeForm()">Create a new Item Attribute</button>
                                    </div>
                                </td>
                            </tr> -->
                        </tbody>
