            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item li-bom">
                    <button class="btn btn-refresh" style="background-color: #d9dbdb;" type="submit"
                        onclick="loadBOM();" onclick="addBOM();">Cancel</button>
                </li>
                <li class="nav-item li-bom">
                    <button style="background-color: #007bff;" class="btn btn-info btn"
                    ...
                    $(document).ready(function() {
                        $('#item_code').autocomplete({
                            ...
                            select: function(event, ui) {
                                // Set selection
                                $('#itemtable-item td').remove();
                                $('#item_code').val(ui.item
                                .product_code); // save selected id to input
...
<script type="text/javascript">
    function addBOM() {
        $(document).ready(function() {
            ...
            form.append('total_cost', total_cost);
            //var rates = {};
            //for(i=0; i<$('#itemtable-item tr').length-1; i++) {
            //  var rateString = "'rate" + (i+1) + "'";
            //  rates[i] = {'rate':$("#rate" + (i+1)).val()}
            //  console.log(rates);
            //}
            //form.set('rates', JSON.stringify(rates))
            $.ajaxSetup({
                headers: {
