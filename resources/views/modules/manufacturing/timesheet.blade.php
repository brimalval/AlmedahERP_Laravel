<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <h2 class="navbar-brand" style="font-size: 35px;">Timesheet</h2>
                    ...
                    <table class="table table-hover h-100">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" style="width: 25%;">Total Working Hours</th>
                                <th scope="col" style="width: 25%;">Total Billed Hours</th>
                            </tr>
                        </thead>
                        <tbody>
                            <!--
                            ...
                            <tr>
                                <td colspan="8">
                                    <div class="text-center" style="padding-top: 100px; padding-bottom: 100px;">
                                        <h4>No Timesheet Found</h4><br>
                                        <button class="btn btn-primary" onclick="openManufacturingTimesheetForm()">Create a new Timesheet</button>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
