              ...
              <div class="row">
                ...
                <div class="col-6">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="">Edit Posting Date and Time</label></div>
                    <div class="row"><input class="form-check-input" type="checkbox" value="" id="">
                    <label class="form-check-label" for="">Inspection Required</label></div>
                    <div class="row"><input class="form-check-input" type="checkbox" value="" id="">
                    <label class="form-check-label" for="">From BOM</label></div>
                  </div>
                </div>
              </div>
            </div>
