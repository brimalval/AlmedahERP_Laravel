<div class="row">
	<div class="col-6">
		...
		<div class="group-link">
			...
			<a class="link" href="#">Payment Entry<span class="badge text-muted"></span><span class="badge bg-danger badge-pill text-light"></span><i class="fas fa-plus ml-1 mt-2"> </i></a><br>
		</div>
	</div>
	<div class="col-6">
		<div class="group-link">
			...
			<a class="link" href="#">Purchase Receipt<span class="badge text-muted"> {{ $counts['pr_count'] }}</span><span class="badge bg-danger badge-pill text-light"></span><i class="fas fa-plus ml-1 mt-2"> </i></a><br>
			<a class="link" href="#">Purchase Invoice<span class="badge text-muted"> {{ $counts['pi_count'] }}</span><span class="badge bg-danger badge-pill text-light"></span><i class="fas fa-plus ml-1 mt-2"> </i></a><br>
		</div>
		<br>
		<div class="group-link">
			<h5 class="font-weight-bold">Pricing</h5>
			<a class="link" href="#">Pricing Rule<span class="badge text-muted"> </span><span class="badge bg-danger badge-pill text-light"></span><i class="fas fa-plus ml-1 mt-2"> </i></a><br>
		</div>
	</div>
</div>