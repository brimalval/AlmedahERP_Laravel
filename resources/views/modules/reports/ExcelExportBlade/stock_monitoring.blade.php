...
<hr></hr>
<h1><b>SUPPLIERS RATES REPORTS </h1></b>
...
<table style="vertical-align:center; {{$has_width ? 'width:100%' : ''}}">
    ...
    @if(!empty($stockMonitoringTable))
        ...
        <tr>
                    ...
                    <td style="border:1px solid black;align:center;vertical-align:center; font-size: 12px; {{$has_width ? 'width:20' : ''}}"><span style="font-family: DejaVu Sans; sans-serif;">&#8369;</span>{{number_format($value->rate,2)}}</td>
