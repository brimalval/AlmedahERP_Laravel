...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    <div class="container-fluid">
        <h2 class="navbar-brand" style="font-size: 35px;">{{ $route->routing_name }}</h2>
        ...
        <div class="collapse navbar-collapse" id="responsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item li-bom">
                    <form action="/delete-routing/{{ $route->id }}" id="deleteMM" method="post">
                        @csrf
                        @method('DELETE')
...
<form action="/update-routing/{{ $route->id }}" method="POST" id="BOM" class="create">
    <br>
    @csrf
    @method('PATCH')
    <div class="container">
        ...
        <table class="table border-bottom table-hover table-bordered" id="operations">
            <thead class="border-top border-bottom bg-light">
                <tr class="text-muted">
                    ...
                    <td class="text-center">Operating Time</td>
                    <td></td>
                </tr>
            </thead>
