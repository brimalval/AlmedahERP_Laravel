...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
  <div class="container-fluid">
    <h2 class="navbar-brand" style="font-size: 35px;">New WorkCenter</h2>
            ...
            <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="Work_Center_Code" id="Work_Center_Code" class="form-control">
                  </div>
                </div>
                <div class="col-6">
                  <div class="form-group">
          ...
          <div id = "f1" style = "display:none">
            ...
            <table class="table border-bottom table-hover table-bordered" id="operations">
                ...
                <tr data-id="${nextID}">
                 ...
                 <td style="width: 15%;" class="mr-qty-input"><input type="number" min="0" value=""  name="Employee_hours" id="Employee_hours" class="form-control"></td>
                 <td style="width: 15%;"  class="mr-qty-input"><input type="number" min="0" value=""  name="Employee_minutes" id="Employee_minutes" class="form-control"></td>
                 <td style="width: 15%;"  class="mr-qty-input"><input type="number" min="0" value=""  name="Employee_seconds" id="Employee_seconds" class="form-control"></td>
                 <td>
              ...
              <td colspan="7" rowspan="5">
                <button type="button" onclick="addRownewEmployee()" class="btn btn-sm btn-sm btn-secondary">Add Row</button>
              </td>
              <br>
            </div>
 ...
 <br>
         <div class="col-6">
            ...
            <table class="table border-bottom table-hover table-bordered" id="operations">
                ...
                <tr data-id="${nextID}">
                 <td id="mr-code-input" class="mr-code-input"><input type="text" value=""   readonly name="machine_process" id="machine_process" class="form-control"></td>
                 <td style="width: 10%;" class="mr-qty-input"><input type="text" value=""  readonly name="setup_time" id="setup_time" class="form-control">
                 <td style="width: 10%;" class="mr-qty-input"><input type="text" value="" readonly name="Running_time" id="Running_time" class="form-control">
