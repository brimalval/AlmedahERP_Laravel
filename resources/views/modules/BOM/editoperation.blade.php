...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
  <div class="container-fluid">
    ...
    <input type="text" name="hiddenId" id="hiddenOpId" value="{{ $operation->id }}" readonly style="display: none">
        ...
        <li class="nav-item dropdown li-bom">
          ...
          <li class="nav-item li-bom">
            <button style="background-color: #007bff;" class="btn btn-info btn" style="float: left;"
                onclick="" id="operationModuleSave">Save</button>
          </li>
        </li>
      </ul>
    </div>
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" name="Operation_Name" id="Operation_Name" class="form-control" value="{{ $operation->operation_name }}">
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    <label for="Default_workcenter">Default Work Center</label>
                    <input type="text" name="Default_WorkCenter" id="Default_WorkCenter" class="form-control" list="work_center_list" value="{{ $operation->wc_code }}">
            ...
            <div class="form-group col-md-12">
                ...
                <textarea id="Description" class="summernote" name="Description">{{ $operation->description }}</textarea>
            </div>
        </div>
    </div>
    <br>
